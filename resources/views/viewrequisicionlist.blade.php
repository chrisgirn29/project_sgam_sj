...
<div class="-mx-4 sm:-mx-6 lg:-mx-8 mt-6">
    ...
    <div class="bg-white shadow p-4 flex justify-between items-center w-full">
        <h1 class="text-2xl font-semibold text-gray-700">
            Detalle de las requisiciones emitidas.:
        </h1>
    </div>
...
function loadCategorias() {
    fetch("{{ route('requisiciones.getListado') }}")
        .then(res => res.json())
        .then(data => {
            ...
            data.forEach(r => {
                ...
                const acciones = `
                    <button
                        ...
                        title="Constancia de no Existencia">
...
document.addEventListener('click', function(e) {
    ...
    if (btn) {
     ...
     window.location.href = `/requisiciones/${id}/no-existencia`;
